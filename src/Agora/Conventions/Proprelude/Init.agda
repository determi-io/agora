...
module Agora.Conventions.Proprelude.Init where

open import Agora.Conventions.Proprelude.Imports
-- open import Agora.Conventions.Proprelude.Equality.Strict
...
data _+-𝒰_ (A : 𝒰 ℓ)(B : 𝒰 ℓ') : 𝒰 (ℓ ⊔ ℓ') where
  left : A → A +-𝒰 B
  right : B → A +-𝒰 B
