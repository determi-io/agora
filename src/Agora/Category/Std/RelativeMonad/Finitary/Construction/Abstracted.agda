...
module Agora.Category.Std.RelativeMonad.Finitary.Construction.Abstracted where

open import Agora.Conventions hiding (_⊔_)

open import Agora.Setoid
open import Agora.Data.AllOf.Collection.Basics
open import Agora.Data.AllOf.Collection.TermTools
...
-- open import Agora.Data.FiniteIndexed.Instance.Category
open import Agora.Category.Std.Category.Subcategory.Full

open import Agora.Algebra.Monoid.Definition
open import Agora.Algebra.Monoid.Free
open import Agora.Data.List.Variant.Binary.Element

open import Agora.Category.Std.RelativeMonad.Finitary.Definition
